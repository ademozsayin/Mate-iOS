...
final class MagicLinkRequestedViewController: LoginViewController {
    ...
    init(email: String, loginWithPassword: @escaping () -> Void) {
        ...
        super.init(nibName: "MagicLinkRequestedViewController", bundle: Bundle.module)
    }
...
private extension MagicLinkRequestedViewController {
    ...
    func setupContinueMailButton() {
        buttonViewController.setupTopButton(title: FiableAuthenticator.shared.displayStrings.openMailButtonTitle, isPrimary: true, onTap: { [weak self] in
    ...
    func setupTitleLabel() {
        ...
        titleLabel.textColor = FiableAuthenticator.shared.unifiedStyle?.textColor
    ...
    func setupSubtitleLabel() {
        ...
        subtitleLabel.textColor = FiableAuthenticator.shared.unifiedStyle?.textColor
    ...
    func setupEmailLabel() {
        ...
        emailLabel.textColor = FiableAuthenticator.shared.unifiedStyle?.textColor
    }
    ...
    func setupCannotFindEmailLabel() {
        ...
        cannotFindEmailLabel.textColor = FiableAuthenticator.shared.unifiedStyle?.textSubtleColor
    }
}
