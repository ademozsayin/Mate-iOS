...
class UnifiedSignupViewController: LoginViewController {
    ...
    override func localizePrimaryButton() {
        submitButton?.setTitle(FiableAuthenticator.shared.displayStrings.magicLinkButtonTitle, for: .normal)
    }
...
private extension UnifiedSignupViewController {
    ...
    func configureInstructionLabel(_ cell: TextLabelTableViewCell) {
        cell.configureLabel(text: FiableAuthenticator.shared.displayStrings.magicLinkSignupInstructions, style: .body)
    }
