...
class PasswordViewController: LoginViewController {
    ...
    private let isMagicLinkShownAsSecondaryAction: Bool = FiableAuthenticator.shared.configuration.isWPComMagicLinkShownAsSecondaryActionOnPasswordScreen
...
private extension PasswordViewController {
    ...
    func configureForgotPasswordButton(_ cell: TextLinkButtonTableViewCell) {
        cell.configureButton(text: FiableAuthenticator.shared.displayStrings.resetPasswordButtonTitle,
    ...
    func configureSendMagicLinkButton(_ cell: TextLinkButtonTableViewCell) {
        cell.configureButton(text: FiableAuthenticator.shared.displayStrings.getLoginLinkButtonTitle,
                             accessibilityTrait: .link,
                             showBorder: true)
