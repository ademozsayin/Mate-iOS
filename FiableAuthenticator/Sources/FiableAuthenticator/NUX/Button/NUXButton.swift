...
@objc open class NUXButton: UIButton {
    ...
    /// Fallback method to configure the background colors based on the shared `FiableAuthenticatorStyle`
    ///
    ...
    /// Fallback method to configure the title colors based on the shared `FiableAuthenticatorStyle`
    ///
