...
class SignupService: SocialUserCreating {
    func createWPComUserWithGoogle(token: String, success: @escaping (Bool, String, String) -> Void, failure: @escaping (any Error) -> Void) {
        
    }
    
    func createWPComUserWithApple(token: String, email: String, fullName: String?, success: @escaping (Bool, Bool, Bool, String, String) -> Void, failure: @escaping (any Error) -> Void) {
