...
// MARK: - FiableAuthenticator Configuration
//

public let WordPressComOAuthDefaultBaseURL = URL(string: "https://wordpress.com")!
public let WordPressComOAuthDefaultApiBaseURL = URL(string: "https://public-api.wordpress.com")!

public struct FiableAuthenticatorConfiguration {
    ...
    public init (wpcomClientId: String,
                 ...
                 wpcomBaseURL: URL = WordPressComOAuthDefaultBaseURL,
                 wpcomAPIBaseURL: URL = WordPressComOAuthDefaultApiBaseURL,
