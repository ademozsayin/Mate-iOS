...
//
public struct FiableAuthenticatorDisplayStrings {
...
public extension FiableAuthenticatorDisplayStrings {
    static var defaultStrings: FiableAuthenticatorDisplayStrings {
        return FiableAuthenticatorDisplayStrings(
