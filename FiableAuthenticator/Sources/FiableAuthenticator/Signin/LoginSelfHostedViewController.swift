...
class LoginSelfHostedViewController: LoginViewController, NUXKeyboardResponder {
    ...
    @IBOutlet var forgotPasswordButton: UIButton!//WPNUXSecondaryButton!
...
//        FiableAuthenticator.track(.loginUsernamePasswordFormViewed)
    }
...
//        siteHeaderView.subtitle = NSURL.idnDecodedURL(siteAddress)
    ...
    @IBAction func handleForgotPasswordButtonTapped(_ sender: UIButton) {
        FiableAuthenticator.openForgotPasswordURL(loginFields)
//        FiableAuthenticator.track(.loginForgotPasswordClicked)
    }
