...
//        FiableAuthenticator.track(.loginPasswordFormViewed)
    }
    ...
    @objc func configureTextFields() {
        ...
        emailLabel?.textColor = FiableAuthenticator.shared.style.subheadlineColor
    }
    ...
    func configureEmailIcon() {
        ...
        emailIcon?.image = image.imageWithTintColor(FiableAuthenticator.shared.style.subheadlineColor)
    }
