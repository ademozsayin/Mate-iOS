...
//        FiableAuthenticator.track(.loginMagicLinkRequestFormViewed)
    }
    ...
    @objc func requestAuthenticationLink() {
        ...
        guard email.isValidEmail() else {
            ...
            alert.addActionWithTitle(NSLocalizedString("Need help?", comment: "Takes the user to get help"), style: .cancel, handler: { _ in FiableAuthenticator.shared.delegate?.presentSupportRequest(from: self, sourceTag: .loginEmail) })
...
//                FiableAuthenticator.track(.loginMagicLinkFailed)
...
//        FiableAuthenticator.track(.loginMagicLinkRequested)
