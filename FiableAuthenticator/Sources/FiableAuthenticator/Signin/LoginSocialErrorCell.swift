...
open class LoginSocialErrorCell: UITableViewCell {
    ...
    private func layoutLabels() {
        ...
        guard let unifiedBackgroundColor = FiableAuthenticator.shared.unifiedStyle?.viewControllerBackgroundColor else {
            backgroundColor = FiableAuthenticator.shared.style.viewControllerBackgroundColor
            return
        }

        backgroundColor = forUnified ? unifiedBackgroundColor : FiableAuthenticator.shared.style.viewControllerBackgroundColor
    }
}
