...
public final class WordPressComOAuthClient: NSObject {
    ...
    public func authenticate(
        ...
        return await oauth2Session
            ...
            .mapSuccess { response in
                ...
                print("Received OAuth2 response: \(self.cleanedUpResponseForLogging(responseObject as AnyObject? ?? "nil" as AnyObject))")
    ...
    public func authenticate(
        ...
        return await socialSession
            ...
            .mapUnacceptableStatusCodeError(AuthenticationFailure.init(response:body:))
            .mapSuccess { response in
                print("Received Social Login Oauth response.")
    ...
    public func authenticate(
        ...
        return await social2FASession
            ...
            .mapSuccess { response in
                ...
                print("Received Social Login Oauth response: \(self.cleanedUpResponseForLogging(responseObject as AnyObject? ?? "nil" as AnyObject))")
                guard let responseDictionary = responseObject as? [String: AnyObject],
