...
public final class NotificationsRemote: Remote, NotificationsRemoteProtocol {
    ...
    public func updateReadStatus(noteIDs: [Int64], read: Bool, completion: @escaping (Error?) -> Void) {
        ...
        let request = FiableRequest(method: .post, path: Paths.read, parameters: parameters)
    ...
    public func updateLastSeen(_ timestamp: String, completion: @escaping (Error?) -> Void) {
        ...
        let request = FiableRequest(method: .post, path: Paths.seen, parameters: parameters)
        let mapper = SuccessResultMapper()
...
private extension NotificationsRemote {
    ...
    ///     - completion: Callback to be executed on completion.
    ///
    func requestForNotifications(fields: Fields? = nil, noteIDs: [Int64]? = nil, pageSize: Int?) -> FiableRequest {
        ...
        return FiableRequest(method: .get, path: Paths.notes, parameters: parameters)
    }
}
