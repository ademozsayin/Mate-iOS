...
extension NoteBlock {
    ...
    ///
    public init(media: [NoteMedia], text: String?, actions: [String: Bool], meta: [String: AnyCodable], type: String?) {
        self.media = media
        self.text = text
...
extension NoteBlock: Decodable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.init(media: media, text: text, actions: actions, meta: meta, type: type)
    }
}
