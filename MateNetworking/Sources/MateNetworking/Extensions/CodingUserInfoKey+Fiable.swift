//
//  CodingUserInfoKey+Fiable.swift
//  Networking
//
...
extension CodingUserInfoKey {
    ...
    /// Used to store the locale within a Coder/Decoder's userInfo dictionary.
    ///
    public static let locale = CodingUserInfoKey(rawValue: "locale")!
    ...
    ///
    public static let userID = CodingUserInfoKey(rawValue: "id")!
