...
/// Defines the supported Fiable API Versions.
///
public enum FiableAPIVersion: String {

    /// No version
    ///
    case none = ""

    /// Fiable Endpoint Mark 1
    ///
    case mark1 = "wc/v1"

    /// Fiable Endpoint Mark 2
    ///
    case mark2 = "wc/v2"

    /// Fiable Endpoint Mark 3
    ///
    case mark3 = "wc/v3"

    /// Fiable Endpoint Mark 4
    ///
    case mark4 = "wc/v4"
