...
/// WeatherApp Constants
///
enum FiableConstants {

    /// App Display Name, used on the About screen
    ///
    static let appDisplayName = "WeatherApp"

    /// CoreData Stack Name
    ///
    static let databaseStackName = "WeatherApp"

    /// Keychain Access's Service Name
    ///
    static let keychainServiceName = "app.fiable.WeatherApp"
    ...
    ///
    static let sharedUserDefaultsSuiteName = "group.app.fiable.WeatherApp"
