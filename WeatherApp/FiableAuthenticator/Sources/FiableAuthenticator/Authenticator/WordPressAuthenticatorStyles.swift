...
//
public struct FiableAuthenticatorStyle {
    ...
    public init(primaryNormalBackgroundColor: UIColor,
                ...
                prologueBackgroundColor: UIColor = UIColor.blue,//WPStyleGuide.wordPressBlue(),
...
//
public struct FiableAuthenticatorUnifiedStyle {
