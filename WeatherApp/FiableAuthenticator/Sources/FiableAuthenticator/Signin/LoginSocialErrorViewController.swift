...
class LoginSocialErrorViewController: NUXTableViewController {
    ...
    private let unifiedAuthEnabled = FiableAuthenticator.shared.configuration.enableUnifiedAuth
...
//        styleNavigationBar(forUnified: forUnified)
    ...
    private func styleBackground() {
        ...
        view.backgroundColor = forUnified ? unifiedBackgroundColor : FiableAuthenticator.shared.style.viewControllerBackgroundColor
    }
...
extension LoginSocialErrorViewController {
    private func numberOfButtonsToShow() -> Int {
        ...
        let unifiedGoogle = true//unifiedAuthEnabled && loginFields.meta.socialService == .google
        let unifiedApple = false//unifiedAuthEnabled && loginFields.meta.socialService == .apple
    ...
    override func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        let footer = UIView()
        footer.backgroundColor = FiableAuthenticator.shared.style.viewControllerBackgroundColor
        return footer
    }
