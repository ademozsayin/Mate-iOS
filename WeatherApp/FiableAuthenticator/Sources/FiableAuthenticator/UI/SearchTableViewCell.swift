...
open class SearchTableViewCell: UITableViewCell {
    ...
    override open func awakeFromNib() {
        ...
        textField.leftViewImage = textField?.leftViewImage?.imageWithTintColor(FiableAuthenticator.shared.style.placeholderColor)

        contentView.backgroundColor = FiableAuthenticator.shared.style.viewControllerBackgroundColor
    }
}
