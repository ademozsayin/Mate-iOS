...
public class LoginTextField: WPWalkthroughTextField  {
    ...
    open override var secureTextEntryImageColor: UIColor! {
        ...
        get {
            return FiableAuthenticator.shared.style.secondaryNormalBorderColor
        }
    }

    open override func awakeFromNib() {
        super.awakeFromNib()
        backgroundColor = FiableAuthenticator.shared.style.textFieldBackgroundColor
    }
    ...
    override open var placeholder: String? {
        didSet {
            ...
            let attributes: [NSAttributedString.Key: Any] = [
                .foregroundColor: FiableAuthenticator.shared.style.placeholderColor,
                .font: font
            ]
    ...
    override open var leftViewImage: UIImage! {
        set {
            let newImage = newValue.imageWithTintColor(FiableAuthenticator.shared.style.placeholderColor)
    ...
    private func drawBorderLine(from startPoint: CGPoint, to endPoint: CGPoint, context: CGContext) {
        ...
        context.setStrokeColor(FiableAuthenticator.shared.style.secondaryNormalBorderColor.cgColor)
        context.strokePath()
    }
}
