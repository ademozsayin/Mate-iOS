...
private extension SiteInfoHeaderView {
    ...
    func refreshBlavatarStyle() {
        if blavatarBorderIsHidden {
            ...
            blavatarImageView.tintColor = FiableAuthenticator.shared.style.placeholderColor
        } else {
            blavatarImageView.layer.borderColor = FiableAuthenticator.shared.style.instructionColor.cgColor
