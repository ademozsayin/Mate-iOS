...
class GoogleSignupConfirmationViewController: LoginViewController {
    ...
    override func localizePrimaryButton() {
        submitButton?.setTitle(FiableAuthenticator.shared.displayStrings.createAccountButtonTitle, for: .normal)
    }
...
private extension GoogleSignupConfirmationViewController {
    ...
    func configureInstructionLabel(_ cell: TextLabelTableViewCell) {
        cell.configureLabel(text: FiableAuthenticator.shared.displayStrings.googleSignupInstructions, style: .body)
    }
