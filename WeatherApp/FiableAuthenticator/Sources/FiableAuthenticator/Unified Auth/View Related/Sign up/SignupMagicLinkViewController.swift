...
final class SignupMagicLinkViewController: LoginViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = FiableAuthenticator.shared.displayStrings.signUpTitle
    ...
    func validationCheck() {
        ...
        if !email.isValidEmail() {
            print("The value of loginFields.username was not a valid email address.")
        }
    }
    ...
    override func localizePrimaryButton() {
        submitButton?.setTitle(FiableAuthenticator.shared.displayStrings.openMailButtonTitle, for: .normal)
    }
}
...
private extension SignupMagicLinkViewController {
    ...
    func configureInstructionLabel(_ cell: TextLabelTableViewCell) {
        cell.configureLabel(text: FiableAuthenticator.shared.displayStrings.openMailSignupInstructions, style: .body)
    }

    /// Configure the "Check spam" cell.
    ///
    func configureCheckSpamLabel(_ cell: TextLabelTableViewCell) {
        cell.configureLabel(text: FiableAuthenticator.shared.displayStrings.checkSpamInstructions, style: .body)
    }

    /// Configure the "Check spam" cell.
    ///
    func configureoopsLabel(_ cell: TextLabelTableViewCell) {
        cell.configureLabel(text: FiableAuthenticator.shared.displayStrings.oopsInstructions, style: .body)
    }
