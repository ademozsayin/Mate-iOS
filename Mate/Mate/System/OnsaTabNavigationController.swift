//
//  OnsaTabNavigationController.swift
//  Mate
//
...
final class OnsaTabNavigationController: OnsaNavigationController {
...
extension OnsaTabNavigationController: UINavigationControllerDelegate {
    // The first view controller always has large title, while the following view controllers in the navigation stack do not have large title by default.
