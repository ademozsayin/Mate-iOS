...
//        static let isIAPAvailable = FiableAnalyticsEvent.LocalNotification.Key.isIAPAvailable
    }
}
...
extension LocalNotification {
    init(scenario: Scenario,
        ...
        let name: String = {
            ...
            guard let name = sessionManager.defaultAccount?.name, name.isNotEmpty else {
