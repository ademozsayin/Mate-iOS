...
extension SurveyViewController {
    enum Source {
        ...
        fileprivate var url: URL {
            switch self {
            case .inAppFeedback:
                return FiableConstants.URLs.inAppFeedback
                    .asURL()
                    .tagPlatform("ios")
                    .tagAppVersion(Bundle.main.version)
            case .productsFeedback:
                return FiableConstants.URLs.productsFeedback
                    .asURL()
                    .tagPlatform("ios")
                    .tagAppVersion(Bundle.main.version)
            case .shippingLabelsRelease3Feedback:
                return FiableConstants.URLs.shippingLabelsRelease3Feedback
                    .asURL()
                    .tagPlatform("ios")
                    .tagShippingLabelsMilestone("3")
                    .tagAppVersion(Bundle.main.version)
            case .addOnsI1:
                return FiableConstants.URLs.orderAddOnI1Feedback
                    .asURL()
                    .tagPlatform("ios")
                    .tagAppVersion(Bundle.main.version)
            case .orderCreation:
                return FiableConstants.URLs.orderCreationFeedback
                    .asURL()
                    .tagPlatform("ios")
                    .tagAppVersion(Bundle.main.version)
            case .couponManagement:
                return FiableConstants.URLs.couponManagementFeedback
                    .asURL()
                    .tagPlatform("ios")
                    .tagAppVersion(Bundle.main.version)
            case .storeSetup:
                return FiableConstants.URLs.storeSetupFeedback
                    .asURL()
                    .tagPlatform("ios")
                    .tagAppVersion(Bundle.main.version)
            case .tapToPayFirstPayment:
                return FiableConstants.URLs.tapToPayFirstPaymentFeedback
                    .asURL()
                    .tagPlatform("ios")
                    .tagAppVersion(Bundle.main.version)
            case .productCreationAI:
                return FiableConstants.URLs.productCreationAIFeedback
                    .asURL()
                    .tagPlatform("ios")
                    .tagAppVersion(Bundle.main.version)
            }
...
//        var feedbackContextForEvents: MateAnalyticsEvent.FeedbackContext {
//            switch self {
//            case .inAppFeedback:
//                return .general
//            case .productsFeedback:
