...
//            return NSAttributedString(string: review.review.strippedHTML).trimNewlines()
            return NSAttributedString(string: review.review)
...
//        let reviewText = NSAttributedString(string: review.review.strippedHTML,
        let reviewText = NSAttributedString(string: review.review,
                                            attributes: [.foregroundColor: textColor])
...
//        return returnValue.trimNewlines()
    ...
    init(showProductTitle: Bool = true, review: ProductReview, product: MateEvent?, notification: Note?) {
