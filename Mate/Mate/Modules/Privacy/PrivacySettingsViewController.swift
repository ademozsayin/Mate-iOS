...
private extension PrivacySettingsViewController {
    ...
    func createMorePrivacyFooterView(text: String) -> UIView {
        ...
        attr.setAsLink(textToFind: Localization.cookiePolicy, linkURL: FiableConstants.URLs.cookie.rawValue)
        attr.setAsLink(textToFind: Localization.privacyPolicy, linkURL: FiableConstants.URLs.privacy.rawValue)
    ...
    func trackURLPresentation(_ url: URL) {
        ...
        case FiableConstants.URLs.cookie.rawValue:
            ServiceLocator.analytics.track(.settingsThirdPartyLearnMoreTapped)
        case FiableConstants.URLs.privacy.rawValue:
...
extension PrivacySettingsViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .morePrivacy:
            presentURL(FiableConstants.URLs.morePrivacyDocumentation.asURL())
        case .usageTracking:
            presentURL(FiableConstants.URLs.usageTrackingDocumentation.asURL())
        default:
            break
        }
    }
