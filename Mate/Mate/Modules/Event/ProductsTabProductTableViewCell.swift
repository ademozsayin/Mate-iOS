//
//  ProductsTabProductTableViewCell.swift
//  Mate
//
//  Created by Adem Özsayın on 7.05.2024.
//
...
extension ProductsTabProductTableViewCell: SearchResultCell {
    typealias SearchModel = UserEvent

    func configureCell(searchModel: UserEvent) {
...
extension ProductsTabProductTableViewCell {
    func update(viewModel: UserEvent) {
