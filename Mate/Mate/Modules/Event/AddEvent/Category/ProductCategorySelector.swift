...
struct EventCategoryConfiguration {
...
struct ProductCategorySelector: View {
    ...
    private let categoryListConfig: EventCategoryConfiguration
    ...
    init(isPresented: Binding<Bool>,
         ...
         categoryListConfig: EventCategoryConfiguration,
