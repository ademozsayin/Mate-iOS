...
final class ProductCategoryListViewController: UIViewController, GhostableViewController {
    ...
    private let configuration: EventCategoryConfiguration
    ...
    init(viewModel: ProductCategoryListViewModel, configuration: EventCategoryConfiguration = .init()) {
...
//        viewModel.$selectedCategory.combineLatest(viewModel.$categoryViewModels)
