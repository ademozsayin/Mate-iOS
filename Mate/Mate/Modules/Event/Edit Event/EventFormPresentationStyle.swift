//
//  EventFormPresentationStyle.swift
//  Mate
//
...
/// How the product form (`EventFormViewController`) is presented.
enum EventFormPresentationStyle {
...
extension EventFormPresentationStyle {
