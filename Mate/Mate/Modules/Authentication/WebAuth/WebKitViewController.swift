...
class WebKitViewController: UIViewController {
    ...
    @objc lazy var refreshButton: UIBarButtonItem = {
        ...
        button.title = NSLocalizedString("Refresh", comment: "Button label to refresh a web page")
        return button
    }()
    ...
    private let linkBehavior: LinkBehavior
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor(light: UIColor.gray(.shade0), dark: .basicBackground)
        ...
        // we are pinning the top and bottom of the stack view to the safe area to prevent unintentionally hidden content/overlaps (ie cookie acceptance popup)
        // then center the horizontal constraints vertically
...
//        navigationBar.shadowImage = UIImage(color: .init(UIColor(red: 46.0/255.0, green: 68.0/255.0, blue: 83.0/255.0, alpha: 0.15)))
        navigationBar.setBackgroundImage(UIImage(ciImage: .white), for: .default)
