...
open class NavigationTitleView: UIView {
    ...
    fileprivate func setupSubviews() {
        titleLabel.font                 = WPFontManager.systemSemiBold(ofSize: NavigationTitleView.defaultTitleFontSize)
        titleLabel.textColor            = .white
        titleLabel.textAlignment        = .center
        titleLabel.backgroundColor      = .clear
        titleLabel.autoresizingMask     = .flexibleWidth

        subtitleLabel.font              = WPFontManager.systemRegular(ofSize: NavigationTitleView.defaultSubtitleFontSize)
