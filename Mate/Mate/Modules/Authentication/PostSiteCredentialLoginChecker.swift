import FiableRedux
import UIKit
import protocol MateNetworking.ApplicationPasswordUseCase
import enum MateNetworking.ApplicationPasswordUseCaseError
...
//        roleEligibilityUseCase.checkEligibility(for: FiableConstants.placeholderStoreID) { [weak self] result in
//            switch result {
//            case .success:
//                onSuccess()
...
//                    self?.showRoleErrorScreen(for: FiableConstants.placeholderStoreID,
//                                             errorInfo: errorInfo,
//                                             in: navigationController,
//                                             onSuccess: onSuccess)
//                } else {
