...
final class AppleIDCredentialChecker: AppleIDCredentialCheckerProtocol {
    ...
    private let authenticator: FiableAuthenticator
    private let stores: StoresManager

    private var cancellable: AnyCancellable?
    private var cancellables = Set<AnyCancellable>()

    init(authenticator: FiableAuthenticator = FiableAuthenticator.shared, stores: StoresManager = ServiceLocator.stores) {
