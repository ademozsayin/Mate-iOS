...
struct AuthenticationConstants {
    ...
    static let emailInstructionHeader =  NSLocalizedString(
        "Log in with your email address to manage your account.",
    ...
    ///
    static let getStartedInstructions = emailInstructionHeader
//    NSLocalizedString(
//        "Log in with your WordPress.com account email address to manage your WooCommerce stores.",
