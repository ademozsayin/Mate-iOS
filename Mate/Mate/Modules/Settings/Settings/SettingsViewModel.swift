...
//    private(set) var announcement: Yosemite.Announcement?
    ...
    ///
    var siteName: String? {
        return "sitename"// stores.sessionManager.defaultSite?.name as String?
    }

    /// Main Site's URL
    ///
    var siteUrl: String? {
        let urlString = "adasdasd"//stores.sessionManager.defaultSite?.url as String?
    ...
    var isStoreSetupSettingSwitchOn: Bool {
        return false//!defaults.shouldHideStoreOnboardingTaskList
    }
