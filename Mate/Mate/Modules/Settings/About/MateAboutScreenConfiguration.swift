...
final class MateAboutScreenConfiguration: AboutScreenConfiguration {
    var sections: [AboutScreenSection] {
        [
            ...
            [
                AboutItem(title: Localization.Titles.fiableFamily,
    ...
    static var appInfo: AboutScreenAppInfo {
        return AboutScreenAppInfo(name: FiableConstants.appDisplayName,
...
private extension MateAboutScreenConfiguration {
    ...
    enum Links {
        ...
        static let instagram        = URL(string: "http://instagram.com/")!
        static let twitter          = URL(string: "http://twitter.com/")!
        static let website          = URL(string: "https://fiable.agency/mate-app/")!
        static let blog             = URL(string: "https://fiable.agency/blog/")!
        static let automatticFamily = URL(string: "https://fiable.agency")!
        static let workWithUs       = URL(string: "https://fiable.agency/work-with-us")!
    }
    ...
    enum Localization {
        enum Titles {
            ...
            static let fiableFamily = NSLocalizedString("Fiable family", comment: "Title of a button linking to the Automattic website")
        ...
        enum Subtitles {
            static let website          = "fiable.agency/mate-app"
            static let blog             = "fiable.agency/blog"
            static let twitter          = "@fiable-agency"
        ...
        static let shareSheetMessage = NSLocalizedString("Hey! Here is a link to download the Mate app. "
...
//        ServiceLocator.analytics.track(.settingsLicensesLinkTapped)
    ...
    enum Links {
        static let termsOfService     = FiableConstants.URLs.termsOfService.asURL()
        static let privacyPolicy      = FiableConstants.URLs.privacy.asURL()
        static let ccpa               = FiableConstants.URLs.californiaPrivacy.asURL()
    }
...
extension Bundle {
    var detailedVersionNumber: String {
        ...
        let versionNumberString = "\(mainBundle.infoDictionary?["CFBundleShortVersionString"] ?? "") (\(mainBundle.infoDictionary?["CFBundleVersion"] ?? ""))"
