...
// Note: This is a copy of the file by the same name in the WordPress iOS codebase.
//
// Before making changes to this, it's worth checking if that one has improved.
//
// See:
// https://github.com/wordpress-mobile/WordPress-iOS/blob/d36cbb90d1bccf29457b1f2ff1406da2dc6bcb3f/WordPress/Classes/Utility/AppLocalizedString.swift
