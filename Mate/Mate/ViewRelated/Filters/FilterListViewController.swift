...
//            case  .productCategories:
//                let selectedProductCategory = selected.selectedValue as? MateCategory
//                let filterProductCategoryListViewController = FilterProductCategoryListViewController(
...
//        }
    ...
    func configureChildNavigationController() {
        let navigationController = OnsaNavigationController(rootViewController: listSelector)
